...
protocol AlbumDetailViewControllerDelegate:AnyObject {
    func userDidChoose(photos:[UIImage])
}
...
class AlbumDetailViewController: DefaultViewController {
    ...
    public weak var albumDetailViewControllerDelegate: AlbumDetailViewControllerDelegate?
    
    // MARK: - Actions
    
    @objc fileprivate func doneBtnClicked() {
        albumDetailViewControllerDelegate?.userDidChoose(photos: Array(selectedPhotos))
